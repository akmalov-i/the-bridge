  ...
  <div>
    ...
    >
      <div class="top">
        <div class="user">
          <div class="content">
            ...
            <button class="btn light" v-if="dataGetter.offer">Сообщение</button>
            <div class="budget" v-if="!dataGetter.offer">
            ...
            <el-button
              ...
              class="btn primary"
              native-type="button"
              @click="acceptTheFixedOffer"
              >Принять</el-button
            >
            <div class="options" v-if="!dataGetter.offer">
      ...
      <div class="send-offer">
        <div class="bottom">
          <div v-show="isCounterOfferOpen || dataGetter.offer">
...
export default {
  ...
  methods: {
    ...
    acceptTheFixedOffer() {
      const formData = {
        budget: this.dataGetter.budget,
        currency: this.dataGetter.currency,
        /* text: this.dataGetter.text.replace(/\r\n/g, ''), */
        text: 'в описании.',
        step: 1,
      ...
      this.$emit('acceptTheFixedOffer', formData)
    },
    acceptTheOffer() {
      this.loading = true
      const formData = {
