    ...
    <form @submit.prevent="send" enctype="multipart/form-data">
      ...
      <div class="edit" v-show="edit">
        ...
        <div class="t-card i4">
          ...
          />
          <div class="addiction">
            <button class="btn add-filter center" @click="enableCard">+</button>
          </div>
        </div>
      ...
      <div class="preview-btns" v-if="!edit">
        ...
        <button class="btn edit" @click="edit = true">Редактировать</button>
        <button class="btn send" type="submit" @click="send">Отправить</button>
      </div>
    </form>
  </div>
</template>
