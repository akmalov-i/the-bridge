...
export default {
  ...
  data() {
    return {
      ...
      form: {
        ...
        periodDateStart: moment().format(),
        periodTimeEnd: '12:00',
        periodDateEnd: moment().add(1, 'days').format(),
        title: '',
        text: '',
  ...
  methods: {
    ...
    changeSubcategory(getCheckedNodes) {
      this.form.mainCategoryLabel = this.mainCategory.find(i => i.value === getCheckedNodes).label
